...
export function TecnologiesCard({ name, icon: Icon,  color = "#3b82f6", cardSize, imgSize, bar }: TecnologiesConfig) {
  return (
    <div className={`w-32 group relative flex flex-col items-center justify-center p-4 bg-mainmuted backdrop-blur-sm border border-slate-800 rounded-3xl transition-all duration-300 hover:bg-slate-800/80 hover:-translate-y-2 shadow-xl ${cardSize}`}
