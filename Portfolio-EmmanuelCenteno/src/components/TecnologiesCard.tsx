import type { TecnologiesConfig } from '../index.ts'

export function TecnologiesCard({ name, icon, color = "#3b82f6", cardSize, imgSize, bar }: TecnologiesConfig) {
  return (
    ...
    >
      ...
      <div className={` ${imgSize !== null ? '' : 'relative mb-3 rounded-2xl group-hover:scale-110 transition-transform duration-300'} `}>
        <img 
          src={icon} 
          alt={name} 
          className={`${imgSize} size-14 object-contain`} 
